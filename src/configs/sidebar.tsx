    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                pathName: "/pharmacy/medicine-list",
                icon: <Inventory2 />,
                requiredPermissions: [ResourceType.Inventory],
                requiredRoles: [Role.Administrator, Role.PharmacyStaff, Role.WarehouseStaff],
            },
            {
                ...
                pathName: "/pharmacy/create-medicine",
                icon: <Inventory2 />,
                requiredPermissions: [ResourceType.Inventory],
                requiredRoles: [Role.Administrator, Role.PharmacyStaff, Role.WarehouseStaff],
            },
            {
                ...
                pathName: "/pharmacy/medicine-interaction-list",
                icon: <Inventory2 />,
                requiredPermissions: [ResourceType.Inventory],
                requiredRoles: [Role.Administrator, Role.PharmacyStaff, Role.WarehouseStaff],
            },
            {
                ...
                pathName: "/pharmacy/create-medicine-interaction",
                icon: <Inventory2 />,
                requiredPermissions: [ResourceType.Inventory],
                requiredRoles: [Role.Administrator, Role.PharmacyStaff, Role.WarehouseStaff],
            },
